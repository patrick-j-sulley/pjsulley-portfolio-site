        ...
        <>
            <div class="work content maxheight">
                ...
                <div class="container-fluid text-end sticky-top pt-4">
                    <Link to="/">
                        <h2 id="redirect-home" class="redirect-home mt-6 me-4 user-select-none d-sm-none d-md-block d-none d-sm-block">patricksullivan</h2>
                        <h2 class="redirect-home-mobile mt-6 me-4 user-select-none d-md-none d-lg-block d-lg-none d-xl-block d-xl-none d-xxl-block d-xxl-none">
                        ps</h2>
                    </Link>
                </div>
            </div>
