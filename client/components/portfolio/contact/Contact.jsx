                        ...
                        <div class="row row-cols-4 my-4">
                            <div id="col">
                                <a href="https://twitter.com/ThePJSIT" target="_blank" alt="Twitter">
                                    <svg class="svg-icon bi bi-twitter" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <div id="col">
                                <a href="https://www.linkedin.com/in/patrick-sullivan-833370134/" target="_blank">
                                    <svg class="svg-icon bi bi-linkedin" viewBox="0 0 54 54">
                            ...
                            <div id="col">
                                <a href="https://github.com/patrick-j-sulley" target="_blank">
                                    <svg class="svg-icon bi bi-github" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1024 1024">
